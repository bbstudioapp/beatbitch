...
void main() {
  group('SpecializationService — file showcase', () {
    ...
    test('invest empile la branche en fin de file', () async {
      ...
      // 4500 s (1 h 15) → 5 points dispo. Trois invest successifs.
      await svc.invest(SpecializationBranch.profondeur, 4500);
      await svc.invest(SpecializationBranch.endurance, 4500);
      await svc.invest(SpecializationBranch.profondeur, 4500);
