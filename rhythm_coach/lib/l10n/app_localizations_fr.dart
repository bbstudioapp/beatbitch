...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get sessionUseMeLabel => 'UTILISE-MOI';

  @override
  String get sessionUseMeUsedLabel => 'UTILISÉE';
  ...
  @override
  String get sessionPostureReadyButton => 'JE SUIS EN PLACE';
  ...
  @override
  String get reputationTierBonneEleve => 'Bonne élève';

  @override
  String get reputationTierPetiteSuceuse => 'Petite suceuse';

  @override
  String get reputationTierSuceuseConfirmee => 'Suceuse confirmée';

  @override
  String get reputationTierPuteReconnue => 'Pute reconnue';

  @override
  String get reputationTierPuteConsacree => 'Pute consacrée';

  @override
  String get reputationTierReineDesSuceuses => 'Reine des suceuses';

  @override
  String get reputationTierReineDesPutes => 'Reine des putes';

  @override
  String get careerInvestmentBarTitle => 'Temps cumulé';
  ...
  String careerInvestmentNextCoach(String name, String remaining) {
    return 'Prochain coach : $name ($remaining)';
  }

  @override
  String get careerInvestmentAllUnlocked => 'Tous les coachs débloqués.';
  ...
  @override
  String get sessionLengthAleatoireLabel => 'Aléatoire';
  ...
  String challengeBannerRhythm(int bpm) {
    return 'Monte le rythme jusqu\'à $bpm BPM';
  }

  @override
  String challengeBannerRhythmShallow(int bpm) {
    return 'Rythme peu profond — monte jusqu\'à $bpm BPM';
  }

  @override
  String challengeBannerRhythmThroat(int bpm) {
    return 'Rythme jusqu\'à la gorge — monte à $bpm BPM';
  }

  @override
  String challengeBannerRhythmFull(int bpm) {
    return 'Rythme à fond — monte à $bpm BPM';
  }

  @override
  String challengeBannerGorgeCrossingsThroat(int count, int bpm) {
    return '$count fois jusqu\'à la gorge à $bpm BPM';
  }

  @override
  String challengeBannerGorgeCrossingsFull(int count, int bpm) {
    return '$count fois jusqu\'au fond à $bpm BPM';
  }
  ...
  String challengeBannerMotionStreak(int seconds) {
    return 'Rythme non-stop $seconds secondes — varie positions et BPM';
  }

  @override
  String challengeBannerNoBreathStreak(int seconds) {
    return '$seconds s sans respirer — rythme et tenues';
  }

  @override
  String challengeBannerNoSwallowStreak(int seconds) {
    return 'Bouche ouverte, langue dehors — $seconds s sans avaler';
  }

  @override
  String challengeBannerBiffleStreak(int seconds) {
    return 'Encaisse les coups $seconds secondes';
  }

  @override
  String challengeBannerBiffle(int bpm) {
    return 'Encaisse les coups jusqu\'à $bpm BPM';
  }
  ...
  @override
  String get coachVoiceShareButton => 'Partager mes réglages de voix';

  @override
  String get coachVoiceShareSheetTitle => 'Partager mes réglages de voix';
  ...
  @override
  String get coachVoiceShareSubject => 'Réglages de voix BeatBitch';
  ...
  @override
  String get musicTapPrompt => 'Tape le rythme de ta musique';

  @override
  String get musicTapAction => 'TAPER';

  @override
  String get musicStart => 'DÉMARRER';

  @override
  String get musicStop => 'STOP';

  @override
  String get musicWaitingTempo => 'Encore quelques taps…';
