...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get sessionPostureReadyButton => 'I\'M IN POSITION';
  ...
  String careerDurationPlusChallenges(String duration) {
    return '$duration + challenge time';
  }
  ...
  String get sessionLengthBacheeDescription =>
      'Express, intense the whole way through.';

  @override
  String get sessionLengthCourteLabel => 'Short';
  ...
  String get sessionLengthCourteDescription =>
      'Compact format, one challenge possible.';

  @override
  String get sessionLengthMoyenneLabel => 'Medium';
  ...
  String get sessionLengthMoyenneDescription =>
      'Up to two milestones, varied content.';

  @override
  String get sessionLengthLongueLabel => 'Long';
  ...
  String get careerChallengesDescription =>
      'One to four opt-in challenges spread through the session, depending on the format you pick. They calibrate fast, can speed up your level progression. Their time adds to the length shown.';
  ...
  String challengeBannerRhythm(int bpm) {
    return 'Ramp the rhythm up to $bpm BPM';
  }

  @override
  String challengeBannerRhythmShallow(int bpm) {
    return 'Shallow rhythm — ramp up to $bpm BPM';
  }

  @override
  String challengeBannerRhythmThroat(int bpm) {
    return 'Rhythm to the throat — ramp up to $bpm BPM';
  }

  @override
  String challengeBannerRhythmFull(int bpm) {
    return 'Rhythm all the way down — ramp up to $bpm BPM';
  }

  @override
  String challengeBannerGorgeCrossingsThroat(int count, int bpm) {
    return '$count crossings to the throat at $bpm BPM';
  }

  @override
  String challengeBannerGorgeCrossingsFull(int count, int bpm) {
    return '$count crossings all the way down at $bpm BPM';
  }

  @override
  String get challengeBannerGorgeApnee =>
      'Throat apnea — alternate holds and deep strokes';

  @override
  String get challengeBannerGorgeEngagement =>
      'Keep the throat in play — holds and deep rhythms';

  @override
  String get challengeBannerDepthMax => 'Push the depth one notch in rhythm';

  @override
  String challengeBannerMotionStreak(int seconds) {
    return 'Non-stop rhythm $seconds seconds — vary positions and BPM';
  }

  @override
  String challengeBannerNoBreathStreak(int seconds) {
    return '$seconds s without breathing — rhythm and holds';
  }

  @override
  String challengeBannerNoSwallowStreak(int seconds) {
    return 'Mouth open, tongue out — $seconds s without swallowing';
  }

  @override
  String challengeBannerBiffleStreak(int seconds) {
    return 'Take the slaps for $seconds seconds';
  }

  @override
  String challengeBannerBiffle(int bpm) {
    return 'Take the slaps up to $bpm BPM';
  }
  ...
  @override
  String get coachVoiceResetRatePitch => 'Original speed and pitch';
  ...
  String get modeSelectionMusicSubtitle =>
      'Lock onto your music: tap the tempo, the steps follow the beat.';

  @override
  String get musicTapPrompt => 'Tap the beat of your music';

  @override
  String get musicTapAction => 'TAP';
  ...
  @override
  String get musicWaitingTempo => 'A few more taps…';
